...
| Source and consent | Standard `LeadSource`; consent status/date/source; channel opt-outs | Affirmative consent requires source and date; record existence never implies consent |
...
| Revenue | Opportunity, six normalization inputs, Amount, Products, Price Book, OCR, external key | Net Amount reconciles and one primary purchasing-fan OCR exists |
| Fan value | tier, score, purchase dates/count, lifetime revenue, lapsed flag | Approved rules are documented and repeatable |
| Tier history | Contact field history for tier; optional lapsed flag history | Old/new values, actor, and timestamps are reportable |
...
| Reporting | reports, snapshots if approved, dashboards, list views | Every card drills to reconciled source records |
