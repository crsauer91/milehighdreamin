...
Give the artist or part-time admin a ten-minute operating view of system health, fan relationships, revenue, service, and next actions.
...
- Every KPI opens a governed report or filtered list; no dead-end cards.
...
- **Healthy:** no unresolved trust exceptions; dashboard data is current.
- **Attention:** exceptions exist but each has an owner and next action.
- **Unreliable:** failed imports, consent gaps, duplicate backlog, or stale purchase data blocks metric interpretation.

## Acceptance checks

- Weekly review takes ten minutes or less.
- Every displayed number reconciles to a source report.
- The user can leave with three owned, dated actions.
